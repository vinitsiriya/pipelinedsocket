  ...
  public  class PipeSocket
    {
        ...
        private static readonly int MinAllocBufferSize = _blockSize / 2;//SlabMemoryPool.BlockSize / 2;
        ...
        public  void Abort(SocketException abortReason)
        {
        ...
        private async Task DoReceive()
        {
            ...
            catch (SocketException ex) when (IsConnectionResetError(ex.SocketErrorCode))
            {
                ...
                error = ex;//new ConnectionResetException(ex.Message, ex);
        ...
        private async Task DoSend()
        {
            ...
            {
                shutdownReason = ex;//new ConnectionResetException(ex.Message, ex);
                //_trace.ConnectionReset(ConnectionId);
            }
            catch (Exception ex)
                when ((ex is SocketException socketEx && IsConnectionAbortError(socketEx.SocketErrorCode)) ||
